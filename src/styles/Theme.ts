...
export const themes: Record<string, Theme> = {
  light: {
    colors: {
      ...
      themeText: '#000000',
      themeColor: '#0d3b1f',
      themeGradient: 'linear-gradient(to right,#0d3b1f, #018a16)',
      background: '#E5E5E5',
      cardBackground: '#FFFFFF',
      selectTopicBg: '#FFFFFF',
      appLogo: '#00',
      buttonText: '#FFFFFF',
      outlineButtonText: '#018a16',
      buttonBackground: 'linear-gradient(90.04deg, #016e11 0.03%, #062412 99.96%)',
 ...
 /* dark: {
    colors: {
      ...
      buttonBackground: 'linear-gradient(90.04deg, #016e11 0.03%, #FFC0CB 99.96%)',
